...
**ダウンロードした画像を必ずReadツールで目視確認**

| NGパターン | 例 | 対応 |
|-----------|-----|------|
| 場所特定できる看板 | 「支笏湖」「春日大社」の文字 | 差し替え |
| 有名ランドマーク | 富士山、伏見稲荷千本鳥居 | 差し替え |
| 別の有名スポット | 奈良の鹿、金閣寺、明治神宮 | 差し替え |
| 寺と神社の混同 | 神社記事に五重塔 | 差し替え |
...
| ファイル | 内容 | 判定 |
|---------|------|------|
| slug-1.jpg | 雪の鳥居、場所不明 | ✅ |
| slug-2.jpg | 「○○神社」看板あり | ❌ → 差し替え |
```

##### 4-4. 汎用画像で差し替え

NGの場合、以下のアップロード済み汎用画像を使用：

| ファイル名 | 内容 |
|-----------|------|
| stone-lantern-path.jpg | 石灯籠の参道 |
| temple-garden.jpg | 寺院の庭園 |
| snow-torii.jpg | 雪の鳥居 |
| snow-temple.jpg | 雪の寺院門 |
| bamboo-path.jpg | 竹林の小道 |
| moss-lantern.jpg | 苔むした石灯籠 |
| peaceful-japan.jpg | 静かな参道 |
...
| 場所特定不可 | 看板・有名建物が写っている | Readツールで画像を目視 |
| 記事との整合性 | 神社記事に五重塔など | 画像内容を確認 |
...
1. **画像について（最重要）**
   - **必ずReadツールで画像を目視確認してから使用**
   - NGパターン: 場所特定できる看板、有名ランドマーク（富士山等）、別のスポット
   - OKパターン: 場所不明の一般的な神社・寺院風景、汎用的要素
   - 1記事に本文画像5枚 + アイキャッチ1枚
   - 問題がある場合は汎用画像（stone-lantern-path.jpg等）で差し替え
