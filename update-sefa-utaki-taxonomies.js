...
// 設定するタクソノミー
const taxonomies = {
  powerspot_region: '沖縄県',
  powerspot_area: '九州・沖縄',  // 英語スラッグ: kyushu-okinawa
  powerspot_type: '遺跡・史跡',    // 英語スラッグ: ruins
  powerspot_benefit: ['厄除け・開運', '心願成就', '縁結び・恋愛運'] // fortune, wish-fulfillment, love-marriage
};
