...
// 設定するタクソノミー
const taxonomies = {
  powerspot_region: '栃木県',
  powerspot_area: '関東',  // 英語スラッグ: kanto
  powerspot_type: '神社',    // 英語スラッグ: shrine
  powerspot_benefit: ['厄除け・開運', '仕事運・出世運', '健康・病気平癒', '家内安全'] // fortune, career, health, family-safety
};
